<template>
  <div
    class="container relative mx-auto w-full text-center h-screen align-middle px-8 pb-8 pt-12 text-white"
  >
    <router-link
      to="/"
        ...
        <div v-if="instagramUserData">
          ...
          >
            ...
            <div class="container sm:text-center lg:text-left">
              <p
                class="text-blue-600 text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-4xl"
